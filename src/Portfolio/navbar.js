  ...
  return (
    <>
      <Box sx={{ flexGrow: 1 }}>
        <AppBar
          position="static"
          sx={{ backgroundColor: "rgba(53, 74, 95, 1)" }}
        >
          <Toolbar>
            <IconButton
              edge="start"
            ...
            <Typography variant="h6" color="inherit">
              ...
              {!isHidden && (
                <span style={{ marginRight: "8px" }}>GOPAL_DEV</span>
              )}
          ...
          <Toolbar>
            <Typography variant="h6" color="inherit" component="div">
              <img
                ...
                alt="not show"
                style={{
                  width: isMobileView ? "120px" : "220px",
                  height: isMobileView ? "30px" : "45px",
                }}
              />
            </Typography>
            ...
            <Typography
              ...
              style={{
                color: "white",
                fontWeight: "bold",
                fontSize: isMobileView ? "15px" : "30px",
                lineHeight: "1.8",
      ...
      <Box sx={{ flexGrow: 1 }}>
        <AppBar
          position="static"
          sx={{ backgroundColor: "rgba(10, 25, 20,70)" }}
        >
          <Toolbar>
            <Typography
              sx={{
                mr: 1,
                backgroundColor: "rgba(10, 25, 20, 70)",
                color: "white",
              }}
            >
              <Select
            ...
            {!isMobileView && (
              <>
                ...
                <Typography
                  variant="h6"
                  component="div"
                  sx={{ mr: 1, color: "white", marginLeft: "20px" }}
                >
                  Exit
                </Typography>
              </>
